...
class QueueMessage
{
     ...
     * but aren't delivered during the 5-minute
     ...
     * Messages that belong to the same message group
     ...
     * use MessageGroupId values (for example, session data
     ...
     * To delete the message or to change the message visibility,
     ...
     * You must provide the most recently received receipt handle when you request to delete the message (otherwise,
    ...
    /**
     * The number of seconds before the message can be visible again when requeuing.
     * Valid values: 0 to 43200. Maximum: 12 hours.
     *
